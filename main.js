...
(function() {
  this.Game = (function() {
    var FPS, _endTime, _game, _generateNote, _index, _isNoteGenerateTiming, _judge, _proccesRootSceneFrame, _status, _timing, _yt;
    ...
    _generateNote = function(number) {
      ...
      return note.addEventListener("touchstart", function(e) {
